# Mosip Sandbox-v2 1.1.5 On Prem Deployment
The following instructions walk you through setps for installing MOSIP sandbox-v2 1.1.5.5 on an on-premise private infrastructure.
...
2. Clone this repo: https://github.com/cylab-africa/mosip-1.1.5-on-prem-deployment.git into your host server by running: `git clone https://github.com/cylab-africa/mosip-1.1.5-on-prem-deployment.git` 
3. cd to the repo: `cd mosip-1.1.5-on-prem-deployment`
4.  After the above, run `bash ./infrastructure_set_up.sh` to setup the MOSIP VMs. This script creates the following VMs where MOSIP will be instaled. Make sure you have SSH keys generated on your host server in the following locations: `~/.ssh/id_rsa` and `~/.ssh/id_rsa.pub` These keys are used by infra set up script.
...
2. Install Git: `sudo yum install -y`
3. Clone this repo: https://github.com/cylab-africa/mosip-1.1.5-on-prem-deployment.git into the console VM server by running: `git clone https://github.com/cylab-africa/mosip-1.1.5-on-prem-deployment.git` 
4. cd to the repo: `cd mosip-1.1.5-on-prem-deployment`
